...
Allaire, JJ. 2022. {``Announcing {Quarto}, a New Scientific and
...
Et {É}cologique Du Transhumanisme Et de Son Monde.''} \emph{Cahiers
Soci{é}t{é}} 3: 99--122. \url{https://doi.org/10.7202/1090180ar}.
...
Hameed, Sharqa. 2023. {``{HTML History} {\textbar} {Explained}.''}
...
Intelligence.''} \emph{Nature} 620 (August): 47--60.
...
IBM. 2023a. {``What Are {Neural Networks}? {\textbar} {IBM}.''}
...
{Utilisateurs} de {TeX}, {LaTeX} Et Logiciels Compagnons.''}
https://www.gutenberg-asso.fr/Les-distributions.
...
Office Suite: {An} Innovation Adoption Study in {Finland}.''} PhD
...
Nouvelle {é}dition. Princenton: Princeton University Press.
...
Markdown Guide. 2023. {``Getting {Started}.''}
...
David Hutchison, Takeo Kanade, Josef Kittler, Jon M. Kleinberg,
Friedemann Mattern, John C. Mitchell, et al., 7313:104--31. Lecture
{Notes} in {Computer Science}. Berlin, Heidelberg: Springer Berlin
Heidelberg. \url{https://doi.org/10.1007/978-3-642-31057-7}.
...
\emph{Open Source Initiative}. https://opensource.org/osd/.
...
{The World Has Changed Fast} -- {What Might Be Next}?''} \emph{Our World
in Data}. https://ourworldindata.org/brief-history-of-ai.
...
Stack Overflow. 2023. {``Stack {Overflow}.''}
...
---------. 2022. {``En Quoi l'open Source Perd de Vue l'{é}thique Du
Logiciel Libre - {Projet GNU} - {Free Software Foundation}.''}
\emph{Syst{è}me d'exploitation GNU}.
https://www.gnu.org/philosophy/open-source-misses-the-point.html.

\leavevmode\vadjust pre{\hypertarget{ref-systemedexploitationgnu23}{}}%
Système d'exploitation GNU. 2023. {``Cat{é}gories de Logiciels Libres Et
Non Libres - {Projet GNU} - {Free Software Foundation}.''}
\emph{Syst{è}me d'exploitation GNU}.
...
Hallucinate}.''} \emph{The New York Times}, May.
...
\emph{{Richard Stallman et la r{é}volution du logiciel libre - Une
biographie autoris{é}e}}. s.l.: Eyrolles.

\leavevmode\vadjust pre{\hypertarget{ref-worldwidewebconsortiumw3c98}{}}%
World Wide Web Consortium (W3C). 1998. {``Extensible {Markup Language}
({XML}) 1.0.''}

\leavevmode\vadjust pre{\hypertarget{ref-Wow}{}}%
{``Wow! {Ten} Million Users!''} n.d.
https://www.overleaf.com/blog/wow-ten-million-users. Accessed March 9,
2024.

\leavevmode\vadjust pre{\hypertarget{ref-xie23}{}}%
Xie, Yihui. 2023. {``Markdown.''}
...
\emph{LSP International Journal} 4 (1).
