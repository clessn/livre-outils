...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, opacityback=0, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Banques de données terminologiques}, bottomrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, coltitle=black, colback=white, arc=.35mm, breakable]
