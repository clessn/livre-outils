...
\includegraphics[width=5.01in,height=\textheight]{images/chapitre8_kanban_notion.png}
...
\includegraphics[width=5.76in,height=\textheight]{images/chapitre5_vscode.png}
...
\includegraphics[width=6.07in,height=\textheight]{images/chapitre5_CVtemp.png}
...
\includegraphics[width=5.51in,height=\textheight]{images/chapitre5_TStemp.png}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6, bottomrule=.15mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Banques de données terminologiques}, left=2mm, titlerule=0mm, coltitle=black]
