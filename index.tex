...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, left=2mm, colframe=quarto-callout-tip-color-frame, colback=white, bottomtitle=1mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Banques de données terminologiques}, breakable, rightrule=.15mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm]
