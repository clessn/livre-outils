...
\hypersetup{
  pdftitle={Outils de recherche en sciences sociales numérique},
  pdfauthor={CLESSN},
  hidelinks,
...
\includegraphics{images/Capture d’écran, le 2023-08-11 à 13.15.13.png}
...
\includegraphics{images/Capture d’écran, le 2023-08-11 à 13.19.08.png}
...
Le champ d\textquotesingle étude de la science politique repose
largement sur l\textquotesingle étude de trois types
d\textquotesingle acteurs distincts ayant un impact sur la condition
politique d\textquotesingle une société~: les décideurs, les médias et
les citoyens. La recherche sur les décideurs comprend entre autres
l\textquotesingle analyse des politiques publiques ou encore
l\textquotesingle analyse de discours de politiciens ou
d\textquotesingle organisations. L\textquotesingle étude des médias
repose largement sur le rôle des médias dans la formation des priorités
et des jugements des citoyens quant aux enjeux politiques, de même que
sur leur capacité d\textquotesingle influencer l\textquotesingle agenda
des politiciens. Au niveau des citoyens, le champ
d\textquotesingle étude de l\textquotesingle opinion publique se
consacre sur l\textquotesingle analyse et l\textquotesingle origine de
comportements ou attitudes politiques des citoyens. De plus, de
nombreuses recherches portent sur la société civile de même que sur les
mouvements sociaux.

Chacun de ces champs de recherches se voit confronté à une panoplie de
défis théoriques et techniques en lien avec l\textquotesingle émergence
des données massives. La révolution technologique permet une étude plus
approfondie des phénomènes auxquels sont confrontés les différents
acteurs de la société démocratique. Toutefois, la collecte de données
permettant de mener à termes de telles études peut
s\textquotesingle avérer complexe. Pour chaque pilier de la démocratie,
les sections suivantes énumèrent et expliquent les capacités techniques
d\textquotesingle outils permettant aux chercheurs
d\textquotesingle accéder à des données massives. Bien que
d\textquotesingle autres outils existent et offrent des résultats
satisfaisants, les méthodes suivantes sont particulièrement pertinentes
dans une optique d\textquotesingle étude des sciences sociales
numériques.
...
L\textquotesingle émergence de nouvelles technologies de même que la
fragmentation médiatique causée notamment par
l\textquotesingle apparition des chaînes de nouvelles en continu
ébranlent considérablement les écosystèmes médiatiques occidentaux
(Chadwick, 2017). L\textquotesingle étude des médias se penchent donc
...
choisir leurs sources d\textquotesingle information, ce qui aurait pour
effet de contribuer à la formation de chambres d\textquotesingle écho.
Ainsi, les études sur les effets des médias visent à comparer les
agendas de différentes organisations médiatiques de même que de
comprendre le cadrage de la nouvelle qu\textquotesingle ils offrent aux
citoyens. Pour effectuer de telles études, l\textquotesingle accès à des
données médiatiques est nécessaire. L\textquotesingle arrivée de données
...
L\textquotesingle outil Factiva offre un accès à
l\textquotesingle ensemble des articles d\textquotesingle une panoplie
de médias provenant d\textquotesingle une vaste sélection de pays. Le
moteur de recherche est opéré par Dow Jones et offre également
l\textquotesingle accès à des documents d\textquotesingle entreprises.
Toutefois, l\textquotesingle accès qu\textquotesingle il offre aux
contenus de média est particulièrement pertinent. Il offre accès à plus
de 15~000 sources médiatiques provenant de 120 pays. Il permet de
télécharger une quantité illimitée de documents RTF pouvant contenir
jusqu\textquotesingle à 100 articles médiatiques chacun. Les articles
peuvent être sélectionnés automatiquement en cochant le bouton proposant
de sélectionner tous les 100 articles de la page de résultat. Chaque
page de résultat contient 100 articles à la fois. Factiva permet
également de filtrer pour les doublons.

L\textquotesingle outil permet de lancer une requête de recherche par
mots-clés et par date qui permet, par exemple, de récolter les articles
médiatiques concernant un sujet précis dans une ligne de temps
déterminée. De manière plus précise, Factiva permet de filtrer la
recherche d\textquotesingle articles par source, par date, par auteur,
par sociétés, par sujet, par secteur économique, par région et par
langue. Disons qu\textquotesingle un chercheur désire comparer la
couverture médiatique d\textquotesingle une élection donnée. Il peut,
...
l\textquotesingle élection. Les mots clés sélectionnés peuvent être
adaptés aux désirs de la personne chercheuse de manière à inclure des
mots qui peuvent être mis ensemble ou à un maximum
d\textquotesingle intervalle de mot. L\textquotesingle utilisation des
signes «~and~» et «~or~» permettent d\textquotesingle ajouter un mot
dans la requête de recherche. En ajoutant near5, l\textquotesingle on
peut spécifier qu\textquotesingle il doit y avoir un maximum de 5 mots
entre les deux mots recherchés. L\textquotesingle on peut également
mettre certains signes à la fin de mots. Par exemple, dans une étude
récoltant des articles sur les immigrants, le mot immigrant pourrait
être écrit de la manière suivante~: immigra*. Ainsi, tous les mots
débutant par ce suffixe seraient inclus de la recherche
d\textquotesingle article, ce qui comprend donc~: immigrant,
immigration, immigrants, immigrante, etc. La Figure 1 est une capture
d\textquotesingle écran de l\textquotesingle interface de recherche de
Factiva.

Ainsi, Factiva permet d\textquotesingle avoir accès facilement à des
données utiles pour de l\textquotesingle analyse textuelle
d\textquotesingle articles médiatiques. Comme les textes deviennent
accessibles aux chercheurs.euses, ils deviennent facilement exploitables
pour faire de l\textquotesingle analyse de contenu par thèmes ou par
ton.

Cependant, ce ne sont pas tous les médias qui sont accessibles sur
Factiva. Dans l\textquotesingle optique ou un média recherché
n\textquotesingle est pas trouvable, le logiciel Eureka représente une
bonne alternative. Eureka se concentre principalement sur les médias
francophones (autant au Québec qu\textquotesingle en Europe). La
structure d\textquotesingle Eureka est similaire à celle de Factiva. En
effet, Eureka permet de filtrer des articles médiatiques par requête de
recherche adaptée à la source, la date ou encore
l\textquotesingle auteur. Toutefois, les requêtes de recherche doivent
être formulées d\textquotesingle une manière quelque peu différente,
elles doivent donc être adaptée au fonctionnement
d\textquotesingle Eureka. Les articles doivent être sélectionnés à la
main et télécharger dans un PDF pouvant contenir un maximum de 50
articles à la fois. La Figure 2 contient l\textquotesingle interface de
recherche d\textquotesingle Eureka.
...
par le biais d\textquotesingle extracteurs qui offrent un accès à des
données massives. Les extracteurs sont des infrastructures de codes
permettant d\textquotesingle extraire des données brutes
d\textquotesingle une source définie. La section suivante explique
...
nécessaires et l\textquotesingle Accès peut être compliqué,
particulièrement dans une perspective de données massives.
C\textquotesingle est pourquoi les extracteurs peuvent être utiles. Un
code peut extraire de manière automatique les débats des Assemblées
nationales, les communiqués de presses, les plateformes électorales, ce
qui offre un accès inégalé aux personnes chercheuses aux données de
décideurs. Dans une autre optique, des extracteurs peuvent également
offrir accès aux données provenant des médias socionumériques comme
Twitter ou Facebook, sur lesquels les acteurs politiques sont souvent
très actifs. Un extracteur peut, par exemple, être en mesure de
répertorier l\textquotesingle ensemble des Tweets de journalistes, de
politiciens ou encore de citoyens de manière automatisée, offrant encore
une fois un accès inégalé aux personnes chercheuses à des données
massives exclusives. L\textquotesingle élaboration
d\textquotesingle extracteurs est toutefois facilitée par
l\textquotesingle existence d\textquotesingle API sur les plateformes
exploitées. Par exemple, Twitter possédait avant les changements de
directions récents un API qui facilite l\textquotesingle élaboration
d\textquotesingle un scraper. En contrepartie, Facebook ne possède pas
d\textquotesingle API, ce qui rend l\textquotesingle accès à ses données
beaucoup plus complexe. ~Un extracteur peut également offrir
l\textquotesingle accès à des données médiatiques, en codant un accès à
des fils RSS ou encore aux HTML des médias extraits.

\hypertarget{covidence-outil-de-ruxe9colte-darticles-scientifiques}{%
\section{\texorpdfstring{\textbf{Covidence~: outil de récolte
d\textquotesingle articles
scientifiques}}{Covidence~: outil de récolte d\textquotesingle articles scientifiques}}\label{covidence-outil-de-ruxe9colte-darticles-scientifiques}}
...
également des outils pouvant être utiles lors d\textquotesingle autres
étapes du cycle de la recherche. Il s\textquotesingle agit notamment du
cas de la revue de littérature, alors que de nombreux outils offrent aux
personnes chercheuses des ressources permettant
d\textquotesingle élaborer un cadre théorique exhaustif par le biais de
données massives sur la littérature scientifique.
L\textquotesingle outil Covidence, géré par une compagnie sans but
lucratif, en est un exemple particulièrement prisé du monde académique
lors de l\textquotesingle entreprise de revues de littérature.
...
organiser l\textquotesingle évaluation de quantité importante
d\textquotesingle études scientifiques. L\textquotesingle exécution
d\textquotesingle une revue de littérature sur Covidence se fait par le
biais d\textquotesingle un double codage. C\textquotesingle est-à-dire
que l\textquotesingle évalutation des études se fait manuellement par
deux codeurs travaillant de manière autonome qui mettront en commun
leurs résultats à la fin de l\textquotesingle exercice. L'outil est
...
effet, l\textquotesingle outil lance des requêtes auprès de multiples
bibliothèques, ce qui offre l\textquotesingle accès à des milliers
d\textquotesingle Études sur le champ étudié par les personnes
chercheuses. Ces requêtes sont adaptées aux besoins spécifiques de la
personne chercheuse voulant explorer en profondeur un domaine de la
...
éliminer ou accepter selon la pertinence de l\textquotesingle article
quant à la littérature étudiée. Cette partie est souvent longue puisque
la littérature existante est souvent massive. Il est donc important pour
...
non » ou « peut-être ». Le vote permet donc soit
d\textquotesingle exclure l'article, de le retenir ou de l'envoyer à la
prochaine étape. En revanche, avoir des conflits rend le travail
beaucoup plus long puisqu'ils ont un texte entier à argumenter. Cette
partie de travail, bien qu'elle comporte beaucoup moins de documents,
est assez longue et exigeante.

La dernière étape, soit celle de l\textquotesingle extraction, consiste
à recueillir toute donnée étant utile à l'étude de la littérature
désignée. Cette étape demande énormément de temps à codifier et extraire
la totalité des articles. Le but est qu\textquotesingle un consensus
entre les codeurs émerge de ce processus. Dans les textes, ces derniers
renferment plusieurs indices sur les mesures recherchés, des dimensions
ainsi que les méthodologies utilisées.

Une fois les étapes de la revue systématique terminées, Covidence
facilite l'exportation des résultats de l\textquotesingle extraction
sous forme de tableaux, de graphiques et de rapports pour la
méta-analyse ou la rédaction d'articles scientifiques.
...
\chapter{La gestion des
références}\label{la-gestion-des-ruxe9fuxe9rences}}

\ul{Plan~: À quoi sert un outil de référence ?}

\ul{\#Pourquoi citer ?}

\ul{\#À quoi sert un logiciel de gestion bibliographique ?}

Avant même de se pencher sur Zotero, bien choisir son logiciel de
gestion bibliographique (puisqu\textquotesingle il existe de nombreuses
possibilités).

\ul{\#\#Grands avantages} (qui sont communs à tous les logiciels de
gestion biblio)

Facilite le travail de recherche ; économie de temps (données
centralisées sur une interface, possibilité d\textquotesingle ajouter
des commentaires et de créer des « sous-groupes »)

Rends le travail d\textquotesingle équipe et de collaboration plus
facile (en travaillant sur le même logiciel

Aucune perte de dossiers

\#\#\#\textbf{BibTeX} (logiciel auxiliaire de LaTeX) qui permet de~:
Gérer et traiter des citations et des bases de données bibliographiques
personnelles :
...
\#\#\#\textbf{EndNote Online}~: EndNote est une application gratuite et
libre permettant de générer des bases de données personnelles de
références bibliographiques. Ces références doivent être saisies
manuellement et peuvent provenir de bases de données ou de catalogues de
bibliothèques.
...
dans un groupe particulier. Cette fonction permet
d\textquotesingle organiser les références de sa bibliothèque et de
faciliter son travail de recherche.

Ce qui distingue EndNote des autres logiciels de traitement
bibliographique~: bien que l\textquotesingle interface soit seulement
dispo en anglais, elle s\textquotesingle adapte aux besoins de
l\textquotesingle utilisateur ainsi qu\textquotesingle aux exigences de
ces travaux. Comme mentionné précédemment, avec ce logiciel, il est
possible de choisir le style bibliographique. En revanche, ce qui la
distingue réellement des autres logiciels est qu\textquotesingle il
possible de franciser et de modifier manuellement
l\textquotesingle interface ainsi que les champs.

\#\#\#\textbf{Carrefour de gestion bibliographique} (site Web du Réseau
de l\textquotesingle Université du Québec sur les logiciels de gestion
biblio) ? Pertinent ?

Afin de choisir le bon logiciel~: page Web qui regroupe toutes les
informations concernant l\textquotesingle utilisation des deux logiciels
principaux de gestion de référence bibliographique~: soit Zotero et
EndNote. Il existe également un quiz afin de savoir quel logiciel répond
le mieux aux exigences et aux besoins de l\textquotesingle utilisateur.

\ul{Mini conclu}

Bien que chaque logiciel à ses spécificités, ils sont tous relativement
similaires. C\textquotesingle est-à-dire qu\textquotesingle ils
permettent tous d\textquotesingle économiser du temps et de rendre le
travail d\textquotesingle équipe plus facile en centralisant les
dossiers.

Ainsi, afin de choisir le logiciel qui répond aux besoins ainsi
qu\textquotesingle aux exigences de l\textquotesingle utilisateur,
celui-ci doit se demander notamment s\textquotesingle il est nécessaire
de partager les résultats de ses recherches ainsi que de travailler en
collaboration. De ce fait, s\textquotesingle il est nécessaire de
partager ses résultats avec le restant de son équipe,
l\textquotesingle utilisateur devrait se munir du même logiciel que ses
collègues. Enfin, il est important d\textquotesingle utiliser le
logiciel que l\textquotesingle utilisateur préfère, comme mentionné
...
qu\textquotesingle il existe une multitude d\textquotesingle outils,
Zotero est le logiciel de gestion bibliographique que nous privilégions
au CAPP. Nous expliquerons ces avantages/inconvénients ainsi que son
utilisation dans la prochaine section de ce chapitre.

\hypertarget{installation-et-configuration-de-zotero}{%
\subsection{Installation et configuration de
