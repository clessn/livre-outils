...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, breakable, colback=white, toprule=.15mm, rightrule=.15mm, coltitle=black, bottomrule=.15mm, opacityback=0, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Banques de données terminologiques}, leftrule=.75mm, left=2mm]
