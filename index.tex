...
\section{Arpentage et choix éditorial
:}\label{arpentage-et-choix-uxe9ditorial}
...
\subsubsection{Gestion de versions en équipe (Pull-push,
...
\paragraph{Inconvénients}\label{inconvuxe9nients}
...
\paragraph{Comment les utiliser efficacement (en parallèle à Dropbox,
...
\paragraph{Pourquoi prioriser Git et GitHub pour les chercheurs en
sciences
...
\paragraph{Pratiques à éviter sur GitHub pour les chercheurs en sciences
...
\paragraph{Exemple d'utilisation de Git et de GitHub pour un chercheur
en sciences
...
\subparagraph{Étape 1~: Création d'un répertoire local et initialisation
de
...
\subparagraph{Étape 2~: Ajout de votre code et de vos
...
\subparagraph{Étape 3~: Ajout, validation et commit de vos
...
\subparagraph{Étape 4~: Création du répertoire sur GitHub et du lien
...
\subparagraph{Étape 5~: Push de votre travail sur
...
\subparagraph{Étape 6~: Collaboration avec vos
...
\subparagraph{Étape 7~: Pull des modifications de vos
...
\subparagraph{Étape 8~: Répéter le
...
\paragraph{GitHub Desktop}\label{github-desktop}
...
\subsection{Gestion de communication}\label{gestion-de-communication}
...
\chapter{First table}\label{first-table}

tbl\_resume\_chap\_X \textless- tibble( ``Critères'' = c(`Accessibilité
(Gratuit ou peu dispendieux)', `Existence d\textquotesingle une
communauté d\textquotesingle utilisateurs', `Popularité dans le champ',
`Compatibilité avec d\textquotesingle autres outils', `Transparence et
réplicabilité', `Adaptabilité et flexibilité'), ``Teams'' = c(`Limitée',
`Oui', `Non', `Avec les outils Microsoft', `Non', `Oui'), ``Slack'' =
c(`Limitée', `Oui', `Oui', `Oui', `Non', `Oui'),\\
``Mattermost'' = c(`Oui', `Non', `Non', `Limitée', `Oui', `Le plus
adaptable') )

tt(tbl\_resume\_chap\_X, width = 0.75, caption = `Résumé des principaux
outils')
...
\subsection{Gestion de données}\label{gestion-de-donnuxe9es}
...
\chapter{Second table}\label{second-table}

tbl\_resume\_chap\_Y \textless- tibble( ``Critères'' = c(`Accessibilité
(Gratuit ou peu dispendieux)', `Existence d\textquotesingle une
communauté d\textquotesingle utilisateurs', `Popularité dans le champ',
`Compatibilité avec d\textquotesingle autres outils', `Transparence et
réplicabilité', `Adaptabilité et flexibilité'), ``Dropbox'' = c(`Limitée
- Abonnement mensuel', `Oui', `Oui', `Oui', `Limitée', `Limitée'),
``Google Drive'' = c(`Oui', `Oui', `Oui', `Avec les outils Google',
`Moyenne', `Oui'), ``OneDrive'' = c(`Limitée', `Oui', `Limitée', `Avec
les outils Microsoft', `Moyenne', `Moyenne'), ``AWS'' = c(`Non', `Oui',
`Limitée', `Oui', `Oui', `Oui') )

tt(tbl\_resume\_chap\_Y, width = 0.75, caption = `Résumé des principaux
outils')
...
\section{Manuel d'instruction :}\label{manuel-dinstruction}

\subsection{Gestion de tâches}\label{gestion-de-tuxe2ches-1}

\subsection{Gestion de communication}\label{gestion-de-communication-1}
...
\paragraph{Structuration}\label{structuration}
...
\paragraph{Optimisation personnelle}\label{optimisation-personnelle}
...
\subsection{Gesstion de données}\label{gesstion-de-donnuxe9es}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Banques de données terminologiques}, opacityback=0, arc=.35mm, coltitle=black, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, breakable, rightrule=.15mm, toptitle=1mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomtitle=1mm, titlerule=0mm, leftrule=.75mm]
