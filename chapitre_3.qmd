...
<span style="color:red;">**J'ajouterai personnellement un paragraphe ou bien quelques phrases afin d'alerter sur les risques d'une trop grande dépendance à Notion (notamment sur la protection des données) ou autres outils similaires  (et l'utilisation du Cloud en général) et plus concrètement sur les enjeux de confidentialité que représente l'utilisation de cet outil (et du Cloud). J'ajouterai (pour le cas spécifique de Notion) que les données sont stokcées aux États-Unis qui sont soumises au Cloud Act et au Patriot Act et qui pourrait ainsi poser des questions légitimes d'accès aux données, notamment pour des utilisateurs non américains (les données étant soumises à la juridiction américaine). Il faudait ainsi inviter les étudiants ou le public qui lit le livre à vérifier si leur institution (laboratoire de recherche, université, école ect...) à vérifier si les logiciels de manière générale (pas que Notion) sont conformes aux normes de ces mêmes institutions.  De plus, il faudrait suggérer à toute personne utilisant Notion de s’assurer d’avoir une copie accessible indépendamment de cet outil .  **</span>
