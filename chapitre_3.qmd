...
COMMENTAIRE: Considérant la prévalence de *Notion* au sein de ce chapitre, et que le paragraphe ci-haut mentionne déjà plusieurs initiatives de Microsoft, je noterais aussi le déploiement progressif de *Microsoft Loop*. *Loop* constitue à mon sens l'outil de Microsoft le plus directement comparable à l'approche « tout-en-un » de *Notion*. Je noterais toutefois que cela ne serait que profitable aux chercheurs ou aux gens dont l'organisation utilise déjà la suite Office, puisque Notion demeure beaucoup plus performant aux yeux de la grande majorité des utilisateurs qui font l'exercice de comparer les deux.
