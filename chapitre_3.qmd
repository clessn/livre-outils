...
Longtemps seule et dominante dans le marché, *Microsoft* est aujourd'hui en compétition avec une multitude d'acteurs. Les premières plateformes collaboratives comme *Basecamp* (1999) et *Jira* (2002) marquent le début du suivi en ligne, permettant aux équipes de travailler à distance, en temps réel, et de suivre leur progression de manière Agile. Développé par la compagnie *Atlassian* et intégrée à *Google Workspace* en 2021, *Jira* se concentre particulièrement sur la gestion des suivis de *bugs*, d'incidents et de projets au niveau « macro », par le suivi des *sprints*, des *objectifs de sprint* et des *backlog*. Elle évolue en parallèle à *Trello* (2011), un autre outil de gestion de projet en ligne racheté par *Atlassian* en 2017. Créé initialement pour pallier à des problèmes de planification interne, Trello se concentre aujourd'hui sur le Kanban utilisateur, pour le suivi « micro » des tâches. Depuis, de nombreuses fonctionnalités supplémentaires ont été introduites, permettant une plus grande flexibilité et créativité dans son utilisation. Par exemple, en 2025, l'application a introduit un planificateur ainsi qu'une boîte de réception permettant de centraliser les tâches venant des autres outils et extensions connectés. Les applications [*Asana*](https://asana.com/) (2008) et [*monday.com*](monday.com) (2012) sont similaires, puisqu'elles sont toutes basées principalement sur le développement et le suivi de projets Agiles via des vues de tâches en tableau Kanban, en calendrier, voire en Gantt (le diagramme de Gantt, même à l'ère de l'Agilité, demeure toujours très populaire).

Des propositions de logiciels libres et à code source ouvert sont bien sûr présentes en ligne. [*OpenProject*](https://www.openproject.org/) (2012) et [*Taiga*](https://taiga.io/) (2014) sont des outils Agiles présentant tous les avantages liés aux logiciels libres tels que la gratuité du service et la possibilité de modification et de redistribution. Toutefois, certaines fonctionnalités restent payantes, sur le modèle du "freemium", et limitent le nombre de projets qu'il est possible de réaliser. 
