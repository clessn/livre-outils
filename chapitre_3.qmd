...
La deuxième valeur illustre concrètement l’esprit de l’Agilité. Dès le départ, un projet Agile doit être divisé en plusieurs livrables, chacun associé à une date d’échéance claire. 

Plutôt que de consacrer des mois — voire des années — à rédiger un devis qui sera de toute façon modifié, l’approche Agile consiste à produire de petits incréments réguliers. Ces résultats partiels font progresser le projet de manière tangible. 

Chaque livrable (par exemple, deux pages de la revue de littérature) peut ensuite être évalué, ajusté et, si nécessaire, amener une révision du plan initial.
