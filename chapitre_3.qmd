...
Le monde de la recherche subit une transformation rapide à l’ère numérique.

L’abondance des outils de recherche s’accroît, tandis que la disparité en matière de compétences numériques se creuse chez les chercheurs, à l’instar de la population en général. Ceux qui investissent du temps pour comprendre et gérer leur « workflow » (l’OQLF recommande la traduction « flux de travaux ») et qui adoptent les meilleurs outils numériques, obtiennent un avantage concurrentiel significatif.\
Cette réalité s’applique non seulement à la recherche scientifique, mais à tous les domaines professionnels.
