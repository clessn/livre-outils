...
Ce chapitre vise à offrir une voie de passage structurée; une classification logique des différents « types » d'outils de gestion de flux de travaux, dans l'objectif de calmer la *FOMO*[^2]. Si les outils numériques changent et évoluent, les méthodologies derrière demeurent.

[^2]: La *FOMO* ou *Fear of missing out* au long est une expression anglophone qui désigne la peur de ne pas tout savoir, d'être en retard sur les tendances, sur les connaissances et les nouvelles opportunités, de manque de l'information potentiellement importante.
...
En somme, Git et GitHub offrent aux chercheurs en sciences sociales numériques un moyen puissant de gérer leur code, de collaborer efficacement et de contribuer à la communauté académique grâce à l'open source. Bien que leur apprentissage puisse représenter un défi initial <! -- Encore une fois, on ne mentionne pas ce qui en fait un défi. Je propose de l'ajouter. -->, les avantages qu'ils apportent en termes de suivi des versions, de collaboration et de partage des connaissances en font des outils essentiels dans l'arsenal de tout chercheur moderne. De plus, la courbe d'apprentissage d'un nouveau langage comme Git peut toujours être atténuée avec l'aide d'outils comme GitHUb Desktop, qui offre une interface facilitant son utilisation, ou les ressources habituelles comme les forums de Stackoverflow ou GitHub, qui offrent des solutions rapidement.
...
-   *Paramètres de notification* : Ajustez vos notifications pour ne pas être submergé. Vous pouvez choisir d’être alerté seulement pour les chaînes prioritaires et désactiver les notifications pour les discussions moins urgentes. De plus, dans l'optique d'un droit à la déconnexion, Slack permet de paramétrer une option «Ne pas déranger» qui vous permet d'identifier vos heures de travail, de ne pas recevoir de notifications hors de ces heures et d'aviser autrui que vous ne prendrez connaissance de sa sollicitation que lorsque vous reviendrez en ligne.
