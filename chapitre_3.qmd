# À la quête de l'optimisation {#sec-chap3}
...
1.  Éllaborer les tâches en fonction des objectifs de sprint.
...
### Stockage des données (Dropbox, autres clouds)
...
### Coordination d'équipe (Slack Mattermost)
...
### Gestion de tâches en équipe (Notion, Monday)

### Gestion de versions en équipe (Pull-push, pull-requests)
