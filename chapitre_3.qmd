# Outils de gestion de projet : la méthode Agile pour le monde académique {#sec-chap3}

\begin{center}
\textit{Adrien Cloutier (Université Laval)}
\end{center}

![](images/chapitre_3_toolbox_walkietalkie_black.png){fig-align="center" width="12%"}

À l'ère du numérique, le monde de la recherche est en fulgurante transformation. Les outils de recherche sont plus nombreux que jamais et l'écart dans la littératie numérique des chercheurs, comme dans la population générale, se creuse chaque année. Avant même de se lancer dans la recherche scientifique (mais ceci est vrai pour tous les domaines d'emplois), les travailleurs qui prennent le temps de s'intéresser et de réfléchir à la gestion de leur « workflow » (l'OQLF recommande la traduction « flux de travaux », expression qui sera utilisée dans ce chapitre pour désigner l'ensemble des pratiques et outils visant à optimiser l'efficacité et la productivité), en visant l'apprentissage et l'utilisation des meilleurs outils numériques sur le marché, sortiront avec un avantage compétitif important par rapport à leurs collègues.

Dans cette quête incessante de l'optimisation du travail, la réflexion sur les méthodes de travail et l'utilisation des bons outils devient une clé de la réussite. Que l'on soit chercheur en herbe ou professionnel chevronné, la manière dont on organise son flux de travaux et gère ses ressources peut déterminer la qualité, la quantité et l'impact de ses résultats professionnels.
...
Autrement dit, la gestion optimale d'un flux de travaux est propre à chacun ! La personnalité, les qualités, les défis, les connaissances, l'emploi du temps et les compétences sont autant de facteurs qui peuvent mener à préférer un outil plutôt qu'un autre, à choisir une méthode de travail particulière plutôt qu'une autre. Les chercheurs qui préfèrent travailler seuls trouveront certains outils davantage utiles. Ceux qui connaissent la suite *Microsoft* par cœur peuvent y demeurer pour la gestion de leurs tâches. Par contre, les chercheurs du genre à collaborer trouveront dans d'autres outils une optimisation de leur communication et de leur gestion de projet. Le flux de travaux est unique à chaque individu, à ses besoins, et ce chapitre permettra d'en structurer un élément central : la gestion de projet.

Il est utile de noter qu'à l'ère du numérique et de la multiplication des technologies de l'information et de la communication, le travail collaboratif est plus simple et nécessaire que jamais. Le chercheur qui travaille seul avec ses livres, ses données et ses idées existe encore, et il a ses raisons. Mais c'est devenu un choix plutôt qu'une nécessité, et rarement le chemin le plus court. Les outils de gestion de projet comme *Notion*, *Trello* ou *Asana* permettent de diviser les activités et d'en suivre les progrès, et les outils de gestion de données comme *git*, *GitHub*, *Google Drive* ou *Dropbox* d'en partager les codes, les fichiers textes, les données et les résultats avec le monde entier (ces outils sont présentés en détail au @sec-chap4). La philosophie et les valeurs du logiciel libre et du code source ouvert s'inscrivent désormais facilement à toutes les étapes du processus scientifique.

Un flux de travaux médité, personnalisé et collaboratif construit en début de carrière tracera la voie d'une efficacité optimisée des années durant, créant et augmentant sur le court, moyen et long terme la « valeur » du chercheur sur le marché professionnel.

Voici un secret : dans le milieu universitaire, des capacités en gestion de flux de travaux permettent au chercheur de se distinguer et d'augmenter rapidement sa valeur en présentant des compétences rares et recherchées. Ceci est vrai dans tous les domaines, mais pour l'étudiant et le professionnel aux études supérieures, à la recherche de moyens de sortir du lot, entouré d'une multitude de collègues brillants qui s'illustrent académiquement, qui s'imposent par leurs expertises techniques et intellectuelles, leur travail acharné et leur volonté d'être remarqué, le savoir-faire en gestion de projet pourrait bien faire la différence.

À la CLESSN, nous avons pris l'habitude de découper le travail académique en six grandes « fonctions » : la communication, la gestion de partenaires, le développement, l'enseignement, le financement et la publication. Ce découpage est le nôtre, il structure jusqu'à nos kanbans, et il nous sert depuis des années. Tout professeur doit jongler presque quotidiennement avec ces fonctions. Dans ses tâches, il est attendu d'enseigner, il en va de soi, mais également de publier des études scientifiques, de travailler avec sa communauté, de développer des projets novateurs et porteurs, d'encadrer des étudiants à la maîtrise et au doctorat, de trouver le financement nécessaire pour mener ses recherches et d'en communiquer les résultats. Un professeur doit faire tout cela, minimalement, en plus de participer à la vie administrative de son département, de diriger des groupes, des centres ou des chaires de recherches, et plus encore.

Rares sont les professeurs, les étudiants ou les professionnels à parfaitement maitriser chacune de ces six fonctions. Certains vont s'illustrer en enseignement, d'autres seront particulièrement doués dans la recherche et la publication scientifique. Il y a ceux que l'on lit dans les journaux, écoute à la radio ou regarde à la télé, vulgarisant leur expertise au grand public. Quelques-uns sont habiles pour remplir des demandes de financements pour leurs travaux de recherches, alors que des scientifiques préfèrent créer des partenariats avec des entreprises de la société civile et développer des projets pour leur collectivité, enregistrant des brevets et quelques fois même, transformant des idées en *start-up*.
...
L'exercice de cette septième fonction est le secret bien gardé des grands talents de notre société. Elle permet d'émerger et de se faire remarquer à l'intérieur d'un immense bassin de personnes qualifiées, voire surdouées, car peu y accordent le temps et l'énergie nécessaire. Pour développer une expertise en gestion de projet dans le milieu académique, ce chapitre présente la méthode Agile et ses outils, en offrant des exemples concrets d'utilisation. Il faut noter cependant que, bien que nous présentions des formes possibles d'utilisation, il existera toujours autant de bonnes façons de travailler qu'il existe d'individus uniques, de contextes ou d'équipes. Ces exemples sont donc offerts uniquement à des fins d'inspiration. Au bout du compte, la réflexion sur la gestion de projet appartient à chacun. L'important est de prendre le temps nécessaire pour mener cette réflexion.

## Point d'observation : retour sur l'origine de la recherche de productivité

### Des méthodes traditionnelles à la gestion scientifique

Avant le XXe siècle, la seule façon d'augmenter la production était d'exiger des travailleurs plus d'efforts et de plus longues heures. Tout change avec l'Américain Frederick Taylor (1856-1915), considéré comme *le père de la gestion scientifique*. Dans *The Principles of Scientific Management* [@taylor11], Taylor fait de l'organisation du travail un objet d'étude en soi, que l'on peut observer, mesurer et améliorer. Son associé, Henry Gantt (1861-1919), a légué son nom à l'une des visualisations de suivi des étapes de production les plus populaires au monde, encore à ce jour. Le *diagramme de Gantt* permet depuis plus d'un siècle de projeter les différentes phases de production d'un projet sur une ligne du temps, en représentant les dépendances entre elles, de manière à prévoir leurs séquences de réalisation. Dans les années 1990, *Microsoft Project* met le diagramme de Gantt sur les ordinateurs de bureau et le popularise bien au-delà des ingénieurs, ouvrant une nouvelle ère de réflexion sur la productivité.

Des pyramides aux chemins de fer, de multiples solutions de gestion ont été développées au cours des siècles, mais l'absence des technologies de l'information et de la communication n'a pas permis avant les années 1950 de structurer et de populariser les idées. En 1958, à la demande de la marine américaine, le *Program Evaluation and Review Technique* (PERT) voit le jour avec comme objectif de structurer le développement du programme de missiles balistiques nucléaires des États-Unis, alors en retard sur celui de l'Union soviétique. La méthode PERT est toujours utilisée aujourd'hui pour visualiser les relations entre tâches, coûts et délais.

À partir de ce succès, les entreprises modernes à la recherche de profits ont vite compris les avantages liés à l'optimisation du travail. Le *Project Management Institute* (PMI) est lancé en 1969 aux États-Unis, structurant et distribuant un langage désormais universel pour la gestion de projet, basé sur l'idée d'une « méthodologie » bien définie. Le PMI décrit la méthodologie comme « un système de pratiques, de techniques, de procédures et de règles utilisé par ceux qui travaillent dans une discipline » [@projectmanagementinstitute21]. De nombreuses méthodologies de gestion de flux de travaux se sont développées au cours des dernières décennies, dans une course vers la *recette secrète* de la productivité d'entreprise. Tous les outils numériques de gestion de flux de travaux contemporains mettent de l'avant une ou plusieurs de ces différentes méthodologies.

### L'émergence de l'Agilité

Aujourd'hui, ces méthodes sont généralement présentées en deux grandes catégories : les méthodes dites « traditionnelles », comme celles présentées ci-dessus (en plus des méthodes Waterfall, PRINCE2, etc.), et les méthodes « Agiles ». L'Agilité voit le jour en 2001, avec la publication du [*Manifeste Agile*](https://agilemanifesto.org/iso/fr/manifesto.html) [@beck_etal01], conceptualisé et destiné au nouveau domaine en pleine expansion du développement logiciel.

Les auteurs se sont toutefois bien retenus d'en inscrire une définition précise, misant plutôt sur une série de valeurs et de principes qui se doivent d'être partagés par tous les membres d'une équipe dite « agile ». C'est peut-être cette décision qui permit à l'Agilité de traverser le temps et de s'inscrire davantage comme une grande philosophie du travail, pouvant être facilement adaptée à divers contexte parfois bien éloigné du développement logiciel, plutôt que comme une méthodologie aux règles strictes.

Ainsi, pour être considéré Agile, un respect des valeurs et des principes demeure essentiel. Contrairement aux méthodes traditionnelles privilégiant la planification du « haut vers le bas » (des décisions prises par les dirigeants, qui envoient les ordres à accomplir à l'intérieur d'un budget et d'un calendrier), la gestion de projet Agile mise sur des cycles itératifs courts, des équipes autonomes et disciplinées, dans une logique du bas vers le haut, basée sur les besoins réels de la clientèle.

Pour illustrer la différence entre les deux approches, un exemple fréquemment donné est celui du logiciel *Excel* de *Microsoft*, dont le développement était, à l'origine, issu d'une méthode traditionnelle de gestion de projet. La compagnie rendait disponible à l'utilisateur des versions créées à l'interne, par des développeurs respectant des budgets, des calendriers et des directives provenant de leur gestionnaire. Dans les années 1990 et 2000, le public a ainsi connu Excel 97, puis Excel 2000, et Excel 2007.
...
Les « méthodes Agiles », grande famille toujours en expansion dont tous les membres (méthodes Scrum, Kanban, XP, etc.) ont en commun la « philosophie » Agile, ont le vent dans les voiles. Leur popularité prouve que la gestion de projet ne se limite pas au déploiement de nouvelles technologies. Cependant, si les entreprises et les administrations ont toutes le réflexe de mettre en place une méthode de gestion de projet, peu d'universitaires prennent le temps de réfléchir à leur processus afin d'optimiser leur production (c'est-à-dire le rapport entre le temps investi, la qualité, la quantité et la pertinence de leurs travaux scientifiques).
...
## Arpentage et choix éditorial : la méthode Agile
...
3.  **La collaboration avec les clients**, plutôt que des négociations contractuelles&nbsp;;
4.  **L'adaptation au changement**, plutôt que le respect d'un plan&nbsp;;

Dans le contexte du milieu académique, cela pourrait se traduire par&nbsp;:

1.  **Des échanges constructifs avec la direction et les pairs**, plutôt que les apprentissages isolés des méthodologies et des outils de recherche&nbsp;;
2.  **Des résultats tangibles et réguliers**, plutôt qu'une idéation interminable&nbsp;;
3.  **Une contribution scientifique utile à la société et à l'avancement des connaissances**, plutôt qu'un acharnement intellectuel aussitôt tabletté&nbsp;;
4.  **L'adaptation aux nouvelles découvertes et aux nouvelles idées**, plutôt que l'application rigide du devis de recherche initial.
...
### L'Agilité au quotidien : travailler seul
...
### Les outils de gestion de projet sur le marché
...
## Manuel d'instruction : utiliser Notion

Notre choix d'outil de gestion de projet compatible avec la philosophie Agile s'arrête sur *Notion*. En août 2024, [*Notion*](https://www.notion.so/fr) dépasse la barre des 100 millions d'utilisateurs. Juste avant la pandémie de COVID-19, *Notion* atteignait son premier million. En l'espace de quelques années, l'outil a rejoint, voire dépassé ses concurrents. Une popularité incontestable, notamment due à sa grande flexibilité.
...
Sur *Notion*, tout (ou presque) est possible. Notion possède d'ailleurs [son propre langage de formules](https://www.notion.so/fr/help/formulas) pour coder des fonctions originales dans des bases de données.

Il n'est toutefois pas nécessaire d'aller dans la complexité : sans être un logiciel libre, *Notion* offre la possibilité à ses utilisateurs de créer leur propre « modèle », et de les offrir (voire de les vendre, si désiré!) à la communauté Web. Ainsi, [des dizaines de milliers de modèles *Notion* sont disponibles en ligne](https://www.notion.so/fr/templates). De multiples modèles sont disponibles pour répondre à tous les besoins : que ce soit pour la gestion des finances ou pour gérer la vie étudiante, la communauté *Notion* est large et structurée. Tous les modèles disponibles s'importent en deux clics et peuvent être modifiés complètement au besoin. Avec le temps et l'expérience, il est même possible de créer ses propres modèles et de les offrir gratuitement (ou à prix fixé !) à la communauté.

L'utilisation individuelle de *Notion* est tout à fait gratuite. En optant pour une version payante, l'utilisateur obtient davantage de possibilités (comme l'utilisation de l'intelligence artificielle intégrée de *Notion*), mais l'utilisation gratuite de base peut être bien suffisante selon les besoins.

L'intelligence artificielle entre aussi dans la gestion de projet, et pas seulement par la fonction payante de *Notion*. Dans notre équipe, un agent lit les notes de nos rencontres et propose les stories correspondantes dans le kanban, avec une échéance et une personne assignée. Un humain valide chaque story avant qu'elle n'existe. C'est le même principe qu'au @sec-chap2 pour le code. L'outil accélère, l'équipe décide.

Avec un seul outil, *Notion* permet de gérer à la fois la vie personnelle et la vie professionnelle. Pour se lancer, [des guides simples sont disponibles sur le site Web](https://www.notion.so/fr/help/category/new-to-notion).

*Notion* possède également sa propre application de calendrier. *Notion Calendar* permet d'importer les calendriers *Google*, en plus d'afficher tous les jours les échéances de stories.

Pour créer une page *Notion* à l'occasion d'un prochain voyage entre amis, rien de plus simple ! Il est possible d'y intégrer une liste d'idées d'activités, un calendrier des destinations, un Kanban rassemblant toutes les tâches à accomplir d'ici au départ, et de partager le tout aux amis via le Web. En quelques clics, toutes les pages *Notion* peuvent être transformées en site Web consultable et modifiable (si on le souhaite et l'autorise).
...
La gestion de projet est une compétence transversale qui peut transformer la manière dont le chercheur aborde ses projets académiques et professionnels. La philosophie Agile, avec ses valeurs de collaboration, de flexibilité et de livraisons régulières, offre un cadre particulièrement adapté au milieu universitaire, où les projets de recherche évoluent constamment au gré des découvertes et des nouvelles orientations. En combinant les approches Scrum et Kanban à l'aide d'outils comme *Notion*, il est possible de structurer son travail de manière itérative, de suivre ses progrès et de collaborer efficacement avec ses collègues. Il faut cependant garder en tête que ces outils et méthodes ne sont que des moyens au service des objectifs de chacun : l'important est de prendre le temps de réfléchir à son propre flux de travaux et de l'adapter à ses besoins, à sa personnalité et à son contexte.
