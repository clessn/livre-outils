...
L'exercice de cette septième fonction est le secret bien gardé de grands talents de notre société. Elle vous permettra d'émerger et de vous faire remarquer à l'intérieur d'un immense bassin de personnes qualifiées, voire surdouées, car peu y accordent le temps et l'énergie nécessaire. Pour comprendre comment développer une expertise en gestion de flux de travaux, ce chapitre présente trois sous-catégories d'outils:
...
Ces valeurs ouvrent la porte à la méthode de travail proposée dans ce chapitre pour appliquer concrètement l'Agilité au contexte académique. Il s'agit d'une proposition unique, testée et adaptée à l'intérieur de plusieurs équipes de recherche. Il est à noter ici que l'Agilité se divise en de multiples méthodologies, telles que Scrum, Kanban, XP, Crystal, Lean, etc. 

Par exemple, la méthodologie Lean - fondée par Kiichiro Toyoda, fondateur de Toyota - est pertinente car elle aide à prévenir les catastrophes liées à la gestion de projet. Plus exactement, elle facilite le processus continu d'ajustement progressif qui va accélérer davantage la livraison de produits en optimisant les ressources et les efforts et en rendant le travail plus efficace. Les deux piliers fondamentaux de la méthodologie Lean sont l'amélioration continue et le respect des personnes. Néanmoins, une difficulté potentielle de cette méthodologie c'est la négligence des métriques qui sont pourtant utiles pour mesurer la réussite des projets et pour améliorer le travail de l'équipe. (Atlassian website)
Lean s'intègre bien avec l'Agilité car les deux sont complémentaires. Si Lean se concentre principalement sur l'élimination du gaspillage et l'optimisation des processus de production afin de maximiser l'efficacité et la valeur ajoutée, lorsqu'on l'intègre avec la méthode Agile, l'adaptabilité et la réactivité sont pris en compte. Le Scaled Agile Framework est une illustration parfaite de cette synergie entre méthode Lean et méthode Agile. La combinaison des deux permet une structure à grande échelle dans les grandes entreprises. (Oliveira 2024)

Toutefois, ce chapitre proposera l'application conjointe des approches Scrum et Kanban, particulièrement adaptée et utile au milieu académique, et qui reposent sur les caractéristiques suivantes:
...
La gestion de flux de travaux est une compétence transversale qui peut transformer la manière dont vous abordez vos projets académiques et professionnels. La philosophie Agile, avec ses valeurs de collaboration, de flexibilité et de livraisons régulières, offre un cadre particulièrement adapté au milieu universitaire, où les projets de recherche évoluent constamment au gré des découvertes et des nouvelles orientations. En combinant les approches Scrum et Kanban à l'aide d'outils comme *Notion*, vous pouvez structurer votre travail de manière itérative, suivre vos progrès et collaborer efficacement avec vos collègues. Rappelez-vous cependant que ces outils et méthodes ne sont que des moyens au service de vos objectifs : l'important est de prendre le temps de réfléchir à votre propre flux de travaux et de l'adapter à vos besoins, à votre personnalité et à votre contexte.
