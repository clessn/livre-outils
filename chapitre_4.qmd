...
En débutant en recherche, vous êtes probablement dans une position où vous devez débuter prochainement la rédaction d'un mémoire ou d'une thèse. Vous avez peut-être commencé à prendre des notes sur la littérature, vous créez des fichiers, vous commencez à collecter des données. Rapidement, une question simple mais cruciale se pose : **où devriez-vous mettre tout ce contenu?**

## Point d'observation : l'évolution de la gestion des données

### Brève histoire de la gestion des données : de l'entreposage personnel à la science ouverte
...
## Arpentage et choix éditorial : où entreposer vos données ?
...
### Pourquoi Git et GitHub pour votre projet de recherche ?
...
```
-->
## Manuel d'instruction : Git et GitHub pour votre projet de recherche
