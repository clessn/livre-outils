...
#reformulation 
Covidence est un outil de revue systématique conçu pour faciliter la recherche scientifique. Bien qu'il ne soit pas un logiciel libre, Covidence offre un modèle de licence adapté à un usage académique et non commercial, ce qui le rend accessible à une large communauté de chercheurs. Son interface intuitive et ses fonctionnalités de collaboration facilitent le processus de revue systématique, en particulier pour les projets de grande envergure impliquant des équipes dispersées géographiquement.
