...
4 types de trad auto, description brève des 4 sans mention de l'IA
neural massive data
Les outils utilisant de l'IA =\> neural et transformer.
Prend une phrase, contexte, intention, etc. plutôt que mots individuels
Forme de generative AI, nlp, deep learning, self-attention (focus sur des parties d'une phrase) etc.

Pertinence ssn: francais vers anglais

AI vs Humain

Exploration de quelques-uns des outils les plus populaires, forces faiblesses Google translate, deepl, chatgpt


L'IA a aussi permis la création d'outils de nouveaux outils de traduction automatique (*machine translation*). Pris au sens large, le concept de traduction automatique englobe n'importe quelle tâche de traduction qui est réalisée par un algorithme, une machine, des ordinateurs, etc. sans aucune aide d'un humain [@glover24][].
