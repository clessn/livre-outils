...
\begin{center}
\textit{Jozef Rivest\footnotemark[1], 
Catherine Ouellet\footnotemark[2]}
\end{center}

\footnotetext[1]{University of Michigan}
\footnotetext[2]{Université de Montréal}
...
Bien que les deux renvoient sensiblement aux mêmes types de logiciels, les tenants de ces approches ne partagent pas la même perspective. Comme @stallman22 l'explique, le logiciel libre est d'abord et avant tout un mouvement qui fait « campagne pour la liberté des utilisateurs de l'informatique ». C'est donc davantage une philosophie dans l'approche de ces logiciels, alors que le code ouvert, quant à lui, met plutôt l'accent sur les avantages pratiques au lieu de militer pour des principes.
...
Jusqu'à présent, il a surtout été question des avantages liés aux logiciels libres. Toutefois, il n'y a pas que des points positifs, et il serait malhônnête de ne pas aborder certaines de leurs limites.
...
Le troisième concerne le développement de sa « pensée de chercheur ». Comprendre et maîtriser certains de ces outils permet de se doter de capacités réflexives qui pourront être mobilisées dès les premiers instants de la recherche, c'est-à-dire dès sa conceptualisation. Dès qu'un intérêt pou un sujet se développe, le chercheur sera mieux outillé pour réfléchir à sa faisabilité et à la manière de récolter et d'analyser les données. Ces compétences contribuent au développement d'un jugement critique, très utile lors de la lecture d'articles et d'ouvrages scientifiques. 
