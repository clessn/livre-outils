...
De plus, motivé par cet objectif inhérent à la science, le chercheur doit s'engager dès les premières étapes de sa recherche. Tout d'abord, il peut déjà établir son flux de travail en créant son dépôt *GitHub* dans lequel il rendra accessibles son code et ses données. Plus d'informations sont présentées dans le @sec-chap4. Ensuite, une fois le plan de recherche[^chapitre_1-10] fait, le chercheur peut le préenregistrer sur le site web de *Open Science Framework*[^chapitre_1-11]. L'objectif de ce site web est que les chercheurs puissent faire état de leurs hypothèses avant la collecte et l'analyse des données afin d'éviter toute manipulation malhonnête *post hoc*. Il s'agit d'un mécanisme qui se veut contraignant afin que les chercheurs s'en tiennent à ce qu'ils ou elles avaient prévu de mener comme recherche.
...
Le premier critère est l'accessibilité au plus grand nombre de ces outils, qui représente le fondement d'une science plus inclusive, dans le respect des moyens de chacun. L'accès à des outils de qualité ne devrait pas être empêché par des verrous d'accès payants.

Cette accessibilité est aussi importante pour deux autres raisons. La première, comme le livre vise à donner des connaissances pratiques dans l'utilisation de ces outils numériques, il est important que les lecteurs aient facilement accès à ce qui est présenté. Cela permet de reproduire au fur et à mesure de la lecture les différents éléments et pratiques qui sont présentés. La deuxième, qui est un corollaire de la première, est qu'une fois ces compétences acquises, les lecteurs pourront facilement les réutiliser pour réaliser les diverses tâches qu'ils souhaitent accomplir.

### L'existence d'une communauté d'utilisateurs

Ensuite, l'existence d'une communauté d'utilisateurs pour les différents outils présentés dans ce livre a été considérée comme importante. Ces communautés permettent une grande collaboration entre les différents utilisateurs d'un même outil, et servent souvent de forum d'aide lorsque des problèmes surviennent. Par conséquent, les lecteurs ont accès à plusieurs forums d'aide sur internet, au besoin, pour la plupart des outils qui sont présentés dans ce livre. Ainsi, ils ont accès à des ressources supplémentaires en ligne lorsqu'une question ou un problème surviendra.

Il se peut que certains logiciels libres n'aient pas de guide d'utilisateur fourni avec le téléchargement du logiciel. Parfois, cela peut être difficile pour ceux qui souhaitent apprendre à utiliser certains de ces outils de se retrouver et de répondre aux questions qui surviennent. C'est pour ces raisons que nous avons considéré l'existence d'une communauté d'utilisateurs, et l'existence de forums d'aide sur le web comme un critère essentiel. Par exemple, pour toutes les questions liées au code, il est possible de consulter le site web de *Stack Overflow*, un important forum d'échange, sur lequel se trouve plusieurs informations et réponses à des questions diverses.

### La popularité en sciences sociales

Nous avons également choisi certains outils à cause de leur popularité dans les disciplines des sciences sociales. Par exemple, en sciences sociales, pour les analyses quantitatives, c'est le logiciel $\textsf{R}$ qui est prédominant aujourd'hui. Non seulement dans son utilisation, mais aussi dans des formations méthodologiques au prestige international, telles que celles offertes par l'*Inter-university Consortium for Political and Social Research* (ICPSR), *Essex Summer School in Social Science Data Analysis* et *The European Consortium for Political Research*. Par conséquent, il s'agit d'une considération pratique. Dans le monde du numérique et de la programmation, certains de ces outils deviennent une forme de langage, et la maîtrise de ce langage permet de dialoguer avec les autres chercheurs de notre champ, ce qui favorise notamment les débats et la recherche collaborative.

### La compatibilité avec d'autres outils

Plusieurs outils ont été choisis parce qu'ils permettent une synergie dans le processus de la recherche. Ainsi, ils s'intègrent bien les uns avec les autres et permettent une connectivité. Par exemple, *Zotero*, présenté dans le @sec-chap5, pour la gestion de sa bibliographie et `Quarto`, présenté dans le @sec-chap8 pour l'écriture, se combinent et permettent ainsi de gagner beaucoup de temps dans l'écriture et la gestion des références. Cette intégration des différents outils est importante puisqu'elle favorise non seulement la productivité et une optimisation individuelle, mais aussi une efficacité dans le processus collaboratif.
...
Le troisième concerne le développement d'une « pensée de chercheur ». Comprendre et maîtriser certains de ces outils permet de se doter de capacités réflexives qui pourront être mobilisées dès les premiers instants de la recherche, c'est-à-dire dès sa conceptualisation. Dès qu'un intérêt pour un sujet se développe, le chercheur sera mieux outillé pour réfléchir à sa faisabilité et à la manière de récolter et d'analyser les données. Ces compétences contribuent au développement d'un jugement critique, élément essentiel à la conduite d'une recherche scientifique.
