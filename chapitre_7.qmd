...
\begin{center}
\textit{Alexandre Bouillon\footnotemark[1],
Hubert Cadieux\footnotemark[1]}
\end{center}
...
#| echo: false
#| fig-cap: "La logique en couches de la grammaire des graphiques [^chapitre_7-2]."
knitr::include_graphics("images/chapitre_7_grammaire_graphique.png", dpi = 600)
```

[^chapitre_7-2]: Image provenant du site officiel de ggplot2: https://ggplot2.tidyverse.org/articles/ggplot2.html
