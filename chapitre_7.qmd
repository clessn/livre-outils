...
[^chapitre_7-1]: Pour plus d'informations sur le Milestones Project, consultez le site web du projet: [https://www.datavis.ca/milestones/index.php?page=introduction](https://www.datavis.ca/milestones/index.php?page=introduction).
...
L’entrée dans le 20e siècle et l’ère informatique ouvrent une nouvelle phase pour la visualisation. La capacité des ordinateurs à traiter rapidement de grandes quantités de données transforme en profondeur les pratiques. Dès les années 1960, les premières visualisations générées par ordinateur permettent d’envisager des représentations plus complexes et dynamiques. Dans les décennies suivantes, des logiciels comme *SAS* et *SPSS* ont rendu ces outils accessibles à un public plus large. 
...
<!--# On présente Excel et Tableau comme poche, mais ils doivent avoir des bons côtés pareil -->
...
<!--# On pourrait montrer ensuite comment on peut modifier les couleurs ou l'apparence graphique avec theme ou aes... -->
...
<!--# Où est la conclusion? Il en faudrait une -->
