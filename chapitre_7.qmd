...
:::::: {.callout-note}
Note ** (J'enlèverais le Note ici puisqu'il y a déjà une mention Note ci-haut): Le rendu de graphiques interactifs n'est pas possible dans un document PDF. Par conséquent, seuls les codes sont fournis ci-dessous. Vous pouvez essayer ces codes dans votre environnement de développement pour voir le résultat.
:::
