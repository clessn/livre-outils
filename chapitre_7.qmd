...
Ainsi, dans la lignée de Tufte, plusieurs chercheurs se sont efforcés à trouver les meilleures façons de transmettre l'information par des graphiques. Arel-Bundock [-@arel-bundock21] résume ces bonnes pratiques en quatre principes fondamentaux.
...
Le troisième principe est celui du contexte. Un graphique doit être auto-suffisant : le lecteur doit pouvoir le comprendre sans avoir à se référer au texte qui l'entoure. Cela implique un titre clair, des axes correctement identifiés, des variables nommées et une légende lorsque nécessaire.
