...
En voici un exemple d'ajout progressif de couches (*layers*) avec le jeu de données `mtcars`, qui accompagne l'installation du logiciel R:
...
Pour explorer davantage les possibilités de `shiny`, nous recommandons de consulter la documentation officielle du package `shiny` ainsi que les sites web qui proposent des exemples plus complexes et des fonctionnalités avancées.
