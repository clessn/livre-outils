...
Dans le premier chapitre de ce livre, les auteurs ont proposé d'aborder la recherche selon une certaine temporalité : avant, pendant et après. Les chapitres qui ont suivi ont tous introduits des outils numériques qui s'inserts dans une ou plusieurs étapes de cette temporalité. L'IA est probablement l'outil le plus transversal. Il s'insert dans chacune de ces étapes. De plus, plusieurs des outils présentés précédemment ont incorporé certaines fonctionalités avec l'IA. Par exemple, les interfaces de programmations come VS Code offrent l'intégration de plusieurs modèles d'IA au sein de leur interface.
