...
Avec l'arrivée de l'intelligence artificielle, les questions suivantes se pose : pourquoi un livre d'outils numériques à l'ère de l'IA? Qu'est-ce que le chercheur devient? Bien évidemment, ces deux questions ne sont que la pointe de l'iceberg, mais dans le contexte de ce livre elles apparaissent être centrales. 

Ce chapitre vise à initier les lecteurs à ce qu'est l'intelligence artificielle (IA), aux enjeux qu'elle engendre ainsi qu'à son potentiel pour les sciences sociales. Dans un premier temps, et en trame de fond de ce chapitre, les lecteurs seront appelés à développer leurs intuitions dans leur utilisation de différents outils de l'IA. Avant tout, au moment où nous écrivons ces lignes, il est important de mentionner que l'étude de l'IA dans les sciences sociales est encore jeune. Par conséquent, beaucoup de questions restent encore en suspens. Face à ce constat, il est important de développer son regard critique afin d'orienter son utilisation de l'IA. Se poser des questions et tenter de trouver des réponses ne peut que générer des bénéfices. Ainsi, si ce chapitre permet d'éclairer certains enjeux, ou s'il stimule davantage de questionnement, alors il aura réussi son objectif.

De plus, ce chapitre aura une structure un peu différente des chapitres précédents. D'une part, l'évolution constante de l'IA et de ses outils se fait à une vitesse folle. Présenter des outils dans ce chapitre ne serait pas d'une très grande utilitée pour les lecteurs puisqu'entre l'écriture de ce chapitre et la lecture les outils qui y seraient présentés auront fort probablement complètement changé. À ce rythme, il est beaucoup plus important de forger son esprit critique et d'approfondir sa connaissance du fonctionnement de l'IA plutôt que de se faire fournir une recette à propos de l'utilisation d'un outil spécifique.

D'autre part, l'IA nécessite une certaine réflexion afin d'en faire une utilisation responsable, éthique et qui ne nuit pas à son développement. Ce livre s'inscrit dans un soucis d'optimization de son espace et de son flux de travail. Mais que veut dire l'optimization au juste? Que cherche-t-on à optimizer? Le but est d'otpimizer son temps et son apprentissage. La réponse à ces questions touche aussi à la seconde question qui est posée en début de chapitre à propos du futur du chercheur. Comme il en sera discuté plus tard dans ce chapitre, utiliser l'IA pour accomplir des tâches nouvelles comme écrire un script de code en entier dans un language que l'on ne connaît pas *n'est clairement pas* une bonne idée. Non seulement c'est une opportunité manquée d'apprendre une nouvelle chose et de diversifier ses compétences en tant que chercheur, mais aussi pour deux autres raisons. La première, et la plus importante, le chercheur reste imputable de se qu'il produit. Si des erreurs s'introduisent dans les résultats de sa recherche et si ces erreurs mènent à des décisions politiques ou sociales néfastent, ce ne sera pas l'IA qui sera blâmé mais bien le chercheur. La seconde, des études récentes démontrent que l'utilisation de l'IA pour accomplir des tâches peut mener à une dette cognitive [@kosmyna_etal25a]. Cela étant dit, l'IA reste tout de même un outil formidable, mais qui nécessite une certaine réflexion afin d'en faire une utilisation informée, responsable et qui ne nuit pas à notre développement cognitif.

Ce chapitre est divisé entre trois grandes sections. Dans un premier temps, une présentation des grands modèles de language (LLM) sera faite afin d'introduire certaines intuitions à propos du fonctionnement de l'IA agentive. À la fin de cette section les lecteurs auront une compréhension élémentaire du fonctionnement de ces modèles ainsi que de leur limitations. Ensuite, une brève présentation de l'évolution de l'IA dans les dernières années sera introduite afin de mettre en contexte les développements de l'IA ainsi que de l'évolution rapide de la performance de ces modèles. Dans un troisième temps, nous introduirons la réflexion quant à l'optimization de son environnement de travail avec l'IA ainsi que les impacts importants qu'une utilisation irréfléchit de l'IA peut amener. L'objectif sera surtout de mettre en garde les lecteurs de la dette cognitive qui se cache derrière l'utilisation de l'IA pour accomplir des tâches à notre place. Finalement, nous terminerons le chapitre avec une réflection à propos de la place du chercheur aujourd'hui dans l'ère de l'IA. 
...
```{r}
#| fig-cap: "Évolution des performances de l'IA comparée aux capacités humaines"
#| echo: false
#| message: false
#| label: fig-evolution
#| warning: false
...
<!-- TODO: revoir cette section pour uniformiser et retirer les outils/produits. Conserver la temporalité de la recherche. Ajouter optimization des acquis. -->

Dans le premier chapitre de ce livre, les auteurs ont proposé d'aborder la recherche selon une certaine temporalité : avant, pendant et après. Les chapitres qui ont suivi ont tous introduit des outils numériques qui s'inserts dans une ou plusieurs étapes de cette temporalité. L'IA est probablement l'outil le plus transversal. Il s'insert dans chacune de ces étapes. De plus, plusieurs des outils présentés précédemment ont incorporé certaines fonctionalités avec l'IA. Par exemple, les interfaces de programmations come VS Code offrent l'intégration de plusieurs modèles d'IA au sein de leur interface.

Cette accessibilité grandissante et l'intégration facile de plusieurs modèles différents offrent d'importants avantages. Il est notamment plus facile d'utiliser des modèles d'IA afin de régler des problèmes de programmations -- pour faire du *debuging*. Sans aucun doute, il s'agit d'une fonctionalité qui est très utile pour aider dans le processus de recherche et identifier des erreurs et des problèmes lorsqu'on en rencontre.
...
Le concept de dette cognitive arrive the @kosmyna_etal25a. Dans leur recherche, ils étudient comment l'activité cérébrale est affectée par l'utilisation d'un moteur de recherche, d'un LLM ou de l'utilisation d'aucun support externe dans l'écriture d'un essai. Comparativement aux participants qui n'avaient pas accès à aucun support externe afin d'écrire leur texte, et qui sont d'ailleurs le groupe ayant la plus forte activité cérébrale et la plus complète, le groupe qui devait accomplir la même tâche à l'aide d'un LLM avait une réduction de près de 55\% dans leur activité cérébrale. Le groupe qui avait accès à un moteur de recherche se situe entre les deux avec une diminution de 34\% d'activité cérébrale, mais où celle-ci était surtout concentrée dans les cortices visuel et occipital. En comparaison, le groupe ayant accès à un LLM avait la plus faible activité cérébrale, et ce pour l'ensemble du cerveau. Leurs résultats montrent aussi que l'utilisation d'un support externe, et notamment l'utilisation d'un LLM, affecte négativement la consolidation de la mémoire, l'efficacité de l'autosurveillance ainsi que le degré d'agentivité percu dans la réalisation de la tâche (p.147). Dans la discussion de leurs résultats, les auteurs sont concernés par une conséquence important de l'IA sur l'éducation : « [...] bien qu'utile pour supporter la performance, [les outils d'IA] pourraient involontairement nuire aux processus cognitifs, à la rétention et à l'engagement authentic avec les matériaux écrits. Si les utilisateurs sont trop dépendant des outils de l'IA, ils pourraient atteindre une fluidité de surface, mais échouer à internaliser le savoir ou à ressentir un sentiment de propriété. » (p. 148) [Traduction des auteurs] 

<!-- TODO: Ajouter un paragraphe de recommandations, et sur le biais du survivant -->

### Clés d'apprentissage

Dans cette sous-section, nous souhaitons suggérer des pistes de réflexions quant à l'intégration de l'IA dans le processus d'apprentissage. La sous-section précédente ne doit pas être comprise comme étant un « découragement » quant à l'utilisation de l'IA. Au contraire, cet outil offre de puissantes solutions, et ne pas l'intégrer dans son environnement de travail serait une erreure. Apprendre à utiliser l'IA sera un acqis important. Cependant, une intégration ainsi qu'une utilisation optimale doivent être réfléchi afin *d'optimiser* l'utilité de cet outil sans pour autant nuire à son propre développement. Par *optimisation*, nous entendons un apprentissage maximal de la matière dans un interval de temps restreint. L'objectif reste, et restera, d'apprendre et de développer ses capacités de chercheur. Dans ce contexte, il est important de comprendre les stratégies d'apprentissage, entre l'actif et le passif. 

Dans leur étude, @bucinca_etal21 mettent en garde contre la surutilisation de l'IA, et le danger de devenir dépendant de cet outil, notamment à cause des problèmes soulignés ci-haut. L'enjeu tient à la façon dont on apprend : l'apprentissage actif contre l'apprentissage passif. Une surutilisation de l'IA afin d'accomplir toutes les tâches tombe dans la catégorie de l'apprentissage passif. Les recherches montrent que ces conditions sont liées à une plus faible rétention de l'information ainsi qu'à une plus faible activation cognitive [@kosmyna_etal25a]. À l'inverse, l'apprentissage active consiste à un engagement plus élevé de la part des étudiants avec la matière. Par example, cela peut consister à explique le contenu du cours à un non-initié, à construire des *flash cards*, à lire activement les lectures d'un cours et annoter tout au long le texte et le résumé dans ses mots, par exemple.^[Pour une courte liste d'apprentissage passif et l'équivalent actif, les lecteurs peuvent consulter cette page web de l'univerité John Hopkins: https://academicsupport.jhu.edu/study-aids/active-versus-passive-learning/] Cependant, l'apprentissage actif peut sembler fastidieux, et peut mener à une impression d'avoir moins appris [@deslauriers_etal19]. Toutefois, les études démontrent que ce sentiment est faux, et que les étudiants qui s'engagent dans le processus d'apprentissage actif performent mieux dans les examens et ont une meilleure compréhension de la matière.

Dans ce cas, utiliser l'IA pour accomplir des tâches que nous ne sommes pas capable de faire ne semble pas être optimale. La première question que l'on devrait se poser est suis-je capable de faire la cette tâche par moi-même? Si la réponse est non, l'IA ne devrait pas être la première ressource vers laquelle on devrait se tourner. On devrait se saisir de cette opportunité pour approfondir sa connaissance et ses capacités. En fait, l'IA serait plus optimale lorsque nous sommes déjà capable d'accomplir une tâche et que nous souhaitons optimiser une partie de cette tâche. De cette façon, on s'assure de maximiser notre propre apprentissage personnel qui nous placera en meilleure position afin d'évaluer et de comprendre ce qui est produit, non seulement par l'humain mais aussi par l'IA lui-même. Ce dernier point est très important. Des études récentes démontrent que l'humain à tendance à être trop confiant dans les recommandations de l'IA et à prendre de mauvaises décisions [@jacobs_etal21]. L'information générée par l'IA doit toujours être évaluée par le chercheur. Pour faire une bonne évaluation de cette information, le chercheur doit au préalable comprendre et avoir une certaine expertise de son domaine. En ce sens, l'apport et la valeur ajouté de l'IA arrive *après* la connaissance, et non pas avant. Comme ce fut dit dans l'introduction de ce livre : « [...] l'IA amplifie un chercheur compétent. Elle ne remplace pas les fondations. Un chercheur qui ne maîtrise pas ses outils ne sera pas libéré par l'IA. Il en sera dépendant, sans pouvoir évaluer la qualité de ce quelle produit. La maîtrise des outils numériques n'est pas rendue obsolète par l'intelligence artificielle. Elle est devenue la condition pour en faire un usage éclairé. »

### L'IA et la science

L'utilisation de l'IA pose aussi des défis importants dans la reproduction de la science. Les résultats de @brodeur_etal26 démontrent que l'IA sous-performent comparativement aux humains dans la détection d'erreurs dans les recherches et dans la reproduction des résultats scientifiques. Ces résultats sont très importants puisqu'ils soulignent la précaution que tous les chercheurs se doivent dans l'utilisation de l'intelligence artificielle. Selon ces auteurs, l'IA atteindra ses meilleures performances lorsqu'elle *complémente* le travail du chercheur, et non pas lorsqu'elle remplace celui-ci. En ce sens, une utilisation complémentaire de l'IA s'impose, dans laquelle le chercheur reste au centre des décisions, de l'interprétation, du jugement et des des échecs complexes [@brodeur_etal26].
...
-   Les deux commandes suivantes permettent d'extraire de l'information supplémentaires:

    -   `chat_prompt$usage$prompt_tokens`: Permet d'accéder aux statistiques d'utilisation de tokens. Vous pouvez donc calculer le coût de votre requête en fonction du modèle que vous utilisez.
