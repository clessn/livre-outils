...
-   Plus de fonctionnalités sont disponibles en python, mais le
...
=> ajouter une phrase sur les différents débats éthiques entre IA et transhumanisme ? Ex expliquer brièvement les courants (extropiens, posthumanistes, etc.).

=> ajouter transition entre considérations philosophiques / théoriques et passage à conseils pratico-pratiques ci-dessous
...
=> expliquer davantage lien entre plagiat -> reproduction de contenu non sourcé → responsabilité de vérifier les sources

=> ajouter une phrase expliquant que le Chat peut inventer des sources / de fausses citations = danger, en lien direct avec la nécessité de vérifier les sources

Aller consulter les ouvrages directement
