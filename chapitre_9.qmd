...
=> ajouter dimension environnementale (bilan carbone des serveurs) difficile à calculer à cause de cette récente apparition (classement des différents niveaux de pollution de chaque IA inexistante auj par ex)
