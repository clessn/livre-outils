...
Ces définitions restent toutefois à préciser, notamment dans le champ d'application de l'IA : qu'en est-il concrètement ? Comment est-ce utilisé ? Comment ça fonctionne ? Tout d'abord, il est important de spécifier que l'IA se divise en plusieurs types. Lister les différentes branches, les différents types ainsi que les différentes applications serait fastidieux, et s'écarterait de l'objectif du chapitre qui se veut plutôt être une introduction à l'IA. Cependant, pour ceux désirant en savoir plus sur le sujet, les articles de McCarthy [-@mccarthy07] et de Hanchen et al. [-@hanchenwangtianfanfuyuanqiduwenhaogaokexinhuang_etal23], ainsi que le Cambridge Handbook of Artificial Intelligence [@konig_etal22] sont très riches et illustratifs sur ce qu'est l'IA ainsi que sur ses champs d'applications. Pour ce chapitre nous nous contenterons de présenter les 3 grands champs de recherche sur l'IA.
...
En bibliographie, la référence serait insérée comme suit, et ensuite j’irai insérer la question et la réponse complète en annexe[^3].

[^3]: Référez-vous à l'Annexe 2 pour un exemple.
