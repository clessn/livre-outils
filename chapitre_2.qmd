...
## Une courte phrase afin de décrire le contenu d’un code Assembleur serait pertinente, selon moi. Exemple : « Ce type de code est constitué de lettres et de chiffre qui ne forme pas toujours des mots du dictionnaire, ils sont aussi généralement regroupés sous forme de colonnes et de lignes. »
...
## Une référence aux IA classiques comme outil d’apprentissage serait pertinente. « Les IA comme ChatGPT ou Gemini sont aussi très pertinents dans l’apprentissage du code. Elles permettent d’expliquer la logique d’un code ou d’une fonction, d’aider à comprendre pourquoi notre code ne marche pas et même de trouver des formulations ou des fonctions inattendues pour coder quelque chose. »
...
## Une partie où il est expliqué la simplicité d’une console R ordinaire pour montrer les avantages de Rstudio serait pertinente, selon moi. En effet, pour quelqu’un qui n’a utilisé que Rstudio ou qui n’a jamais codé, ce sont des avantages qui n’ont pas beaucoup de sens.
