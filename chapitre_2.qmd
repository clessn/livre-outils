...
Il existe deux types de langages de programmation pour analyse de données. Les logiciels à licences comme SAS, STATA et SPSS, et les langages *open source* tels que Python et Julia. 
...
L'un de ses grands avantages est qu'il est *open source*. 
...
1) l'*open source* est gratuit d'utilisation; 
2) l'*open source* est développé par les utilisateurs et non par des corporations, ce qui lui procure une grande flexibilité; et 
...
D'autres disent que le développement *open source*, spécifiquement celui du langage de programmation R, se fait de façon anarchique. 
