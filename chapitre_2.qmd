...
<span style="color:red;">** J'encouragerai, en plus des outils proposés, de se développer et d'apprendre la programmation sur Youtube ou bien de se tourner vers les livres souvent disponibles dans les bibliothèques (universitaires ou non), surtout dans la mesure où Youtube est gratuit tandis que certaines plateformes comme DataCamp sont payantes et peuvent être parfois difficiles à utiliser au début. En plus de cela, recommander un apprentissage qui mélange ces outils afin de collecter le plus d'informations possibles et dans des cas et exemples différents afin de mieux intégrer les connaissances**</span>
