...
Citer ses sources est une pratique incontournable dans le domaine académique. Cette pratique est primordiale et a plusieurs utilités. D'abord, cela permet de s'inscrire dans une littérature existante. Chaque personne chercheuse construit sur ce qui a déjà été fait par d'autres collègues académiques, s'inspirant des recherches précédentes et dialoguant les unes avec les autres. Le référencement aux autres articles offre la possibilité d'aller y chercher des informations utiles à notre propre recherche. En outre, la science doit être publique afin de vérifier la fiabilité des méthodes employées et des résultats obtenus. Une erreur dans la méthodologie ou dans l'analyse des résultats d'une étude peut être corrigée par d'éventuelles contributions scientifiques s'il est possible de s'y référer. Finalement, citer ses sources est une preuve de transparence, d'éthique et donne de la crédibilité à notre contribution. Cette pratique favorise l'honnêteté intellectuelle en reconnaissant l'apport d'autres personnes chercheuses à sa propre contribution scientifique.

<!--Nouvelle intro--> La citation des sources joue un rôle essentiel dans le milieu académique, offrant de nombreux avantages. Tout d'abord, elle nous permet de nous insérer dans le contexte de la recherche existante. Chaque personne chercheuse s'appuie sur les travaux précédents de ses pairs, en utilisant leurs découvertes comme point de départ et en engageant un dialogue continu. Référencer d'autres articles nous offre également la possibilité d'accéder à des informations pertinentes pour notre propre recherche. De plus, la transparence et la fiabilité de la science sont cruciales. La possibilité de vérifier les méthodes et les résultats d'une étude est indispensable. Si des erreurs sont découvertes dans la méthodologie ou l'analyse des résultats, d'autres chercheurs et chercheuses peuvent les corriger grâce aux références fournies. Enfin, la citation des sources est une démonstration de transparence et d'intégrité, renforçant la crédibilité de notre travail. Enfin, elle favorise l'honnêteté intellectuelle en reconnaissant la contribution des autres chercheurs à notre propre travail scientifique.
...
Le désavantage de Zotero est qu'il peine à gérer d'immenses librairies comportant plusieurs milliers de fichiers.<!--#Est-ce qu'il y a d'autres désavantages? Par exemple: est-ce qu'on doit parfois corriger des erreurs ou ajouter manuellement des informations dans les sources? -->

<!--Commentaire Marc: ^ Je seconde. Et aussi mettre + d'accent sur pourquoi les force sont des forces.   --> 


## Pourquoi BibLaTeX? - Cette section a été écrite à l'aide de ChatGPT

<!--Commentaire Marc: Je mettrais + d'accent sur le lien avec le langage de balisage qu'on présente dans le livre, je trouve ce chapitre un peu déconnecté des autres.   --> 
...
Compatibilité avec Unicode: Contrairement à BibTeX, BibLaTeX est entièrement compatible avec Unicode, ce qui permet d'utiliser des caractères non-latins (comme le cyrillique, l'arabe ou les idéogrammes asiatiques) dans vos références. <!--# Peut-être ajouter une courte description pour expliquer Unicode (je crois qu'on n'en parle pas dans les chapitres précédents) -->

<!--Commentaire Marc: ^ Pas certains qu'on a à s'embarquer dans Unicode mais à vous de voir.  --> 
...
<!--Commentaire Marc: Qu'est-ce que ça veut dire, une citation avancée?  --> 
...
<!--Commentaire Marc: Comme plusieurs autres points ci-haut, il n'est pas le seul. Rendu ici dans la lecture, je ne suis pas certain de ce qui distingue ce qu'on propose des autres alternatives. Ça feel plutôt comme une description plutôt qu'une explication de pourquoi c'est l'outil à utiliser.  --> 
...
<!--Commentaire Marc: C'est pas un copié-collé du ReadMe ça?  --> 
...
<!--# Je crois qu'il serait intéressant d'ajouter quelques ressources supplémentaires pour ceux/celles qui veulent aller plus loin dans leur utilisation de Zotero ou BibLaTeXs -->

<!--Commentaire Marc: ^ C'est à ce dont sert le chap. 10, je ne mettrais pas ça dans ce chapitre.  --> 
