...
*Les données médiatiques* -> j'aurais surement mentionné quelques outils de collecte de données médiatiques dans cette partie, comme FACTIVA, EUreka ou Mediaccloud 
