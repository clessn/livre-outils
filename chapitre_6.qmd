...
tbl_resume_chap_6_collecte <- tibble(
  ...
  Eureka = c(
    "Payant (institutionnel)",
    "Limitée (francophone)",
    "Populaire (milieu francophone)",
    "Partielle (texte intégral)",
    "Propriétaire",
    "Peu flexible"
  ),
  rvest = c(
