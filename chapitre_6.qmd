...
<!--
On pourrait citer KKV ici? Peut-être aussi citer d'autre sources?
...
<!--
Mentionner que de ne pas utiliser ces outils peut être considéré comme une perte de temps. Permet de sauver des heures de travail et de ne pas avoir à se soucier des détails de formatage. Pas besoin de mémoriser des détails superflus à propos de styles de citations différents et permet de se concentrer sur le contenu de nos travaux. De plus, utiliser ces outils permet de changer de style instantanément et donc de pouvoir s'adapter aux différentes revues scientifiques.
-->
...
<!--
Ajouter une transition de Zotero à BibLaTeX
-->
## Pourquoi BibLaTeX?
...
<!-- Ajouter une section sur l'extension Betterbibtex et faire la transition avec BibLaTeX -->
...
<!--
L'avantage principale est que l'utilisation d'un logiciel de gestion des references rend le référencement agréable. 
-->