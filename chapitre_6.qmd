...
### Historique de la visualisation graphique
...
#| echo: false
#| fig-cap: "La logique en couches de la grammaire des graphiques [^chapitre_6-3]."
knitr::include_graphics("images/chapitre6_grammar_graphic.png", dpi = 600)
```

[^chapitre_6-3]: [Image provenant du site officiel de ggplot2](https://ggplot2.tidyverse.org/articles/ggplot2.html).
