...
?? Il serait fort interessant de disctuter du machine leraning et comment cette technique de classification de données peut etre utiliser dans un contexte de la recherche. Par exemple inclure avec un web SCrapper un code de machine learning qui ressort les caarctéristiques voulues d'une certaine mainière etc. mettre plus d'emphase sur les possibilitées diverses de la collecte de donnée numérique.
