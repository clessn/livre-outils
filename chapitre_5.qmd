...
\begin{center}
\textit{Sarah-Jane Vincent\footnotemark[1],
Camille Pelletier\footnotemark[2],
Laurence-Olivier M. Foisy\footnotemark[3]}
\end{center}

\footnotetext[1]{Stony Brook University}
\footnotetext[2]{Université Laval}
\footnotetext[3]{Université Laval}
...
# Plusieurs autres types d’outils de synthèses de la connaissance pourraient être abordés, comme Consensus ou Elicit qui retrouve des articles de revues scientifiques sur des sujets ou des questions qu’on lui demande. Il y a aussi ResearchRabbit ou Inciteful qui permettent de voir les réseaux de citation et de comprendre comment et à quelle autre étude un article ou un champ de la littérature sont-ils reliés.
