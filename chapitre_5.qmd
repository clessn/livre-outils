...
Je proposerais d’ajouter une courte précision sur l’importance de savoir faire une bibliographie sans dépendre entièrement d’un logiciel (même si j'ai conscience que le but du livre est de familiariser aux outils et logiciels). Même si Zotero ou Mendeley facilitent beaucoup le travail, il peut arriver qu’un étudiant n’y ait pas accès à un moment donné (par ex à cause d’un bug ou d’un changement d’ordinateur). Il faudrait ainsi peut être sensibiliser sur cet aspect dans la mesure où connaître les bases des styles de citation et être capable de vérifier soi-même ses références peut aider à rester rigoureux et indépendant malgré tout. Ainsi, un usage maitrisé indépendamment de tout outil couplée à l'utilisation de l'outil se reveler être encore plus efficace.