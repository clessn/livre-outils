...
Ce qui la rend scientifique tient à sa méthode plutôt qu'au nombre de textes lus. Une revue solide documente comment les études ont été trouvées, selon quels critères elles ont été retenues ou écartées, et comment elles ont été analysées. Le *snowballing*, la revue de portée et la revue systématique répondent chacun à cette exigence à leur façon. Ces méthodes s'enseignent à l'université et leurs résultats se publient.
