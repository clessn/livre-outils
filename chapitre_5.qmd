...
Quant aux médias, l'arrivée de données massives ouvre de nouvelles avenues de recherche pour les chercheurs. euses en sciences sociales  parce que l'importante quantité de données accessibles aux chercheurs.euses permet une compréhension accrue des réalités médiatiques modernes, marquées par la fragmentation. L'outil Factiva offre un accès plus de 15 000 sources médiatiques de 120 différents pays. Le moteur de recherche est opéré par Dow Jones et offre également l'accès à des documents d'entreprises. Pour la communauté scientifique, ce contenu est très pertinent, particulièrement en communication. Factiva permet de télécharger une quantité illimitée de documents RTF, un format de fichier de texte qui peut contenir jusqu'à 100 articles. En outre, ils peuvent être sélectionnés automatiquement en cochant le bouton proposant de sélectionner les 100 articles de la page de résultats. Enfin, Factiva permet également de filtrer les doublons. Ainsi,la base de données offre un accès facile à des données utiles à l'analyse textuelle d'articles médiatiques. Comme les textes deviennent accessibles rapidement et simplement aux chercheurs.euses, cet outil optimise considérablement l'analyse de contenu par thème ou par ton. Cependant, ce ne sont pas tous les médias qui sont accessibles sur Factiva. Dans l'optique où un média recherché n'est pas accessible sur Factiva, le logiciel Eureka représente une bonne alternative. Eureka se concentre principalement sur les médias francophones (autant au Québec qu'en Europe). La structure d'Eureka est similaire à celle de Factiva. 
